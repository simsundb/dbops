...
WHERE strpos(d.distribute_columns,',') > 0 
    ...
    OR d.distribute_type NOT IN ('REPLICATION','HASH')
ORDER BY d.schema_name, d.distribute_type, d.distribute_columns, NVL(p.partition_type,'NONPARTITION'), p.partition_columns